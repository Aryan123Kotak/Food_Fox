...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content" data-aos="fade-up">
            <h3>Discover Best Food & Drink Near Changa</h3>
            <p>Get fresh, local food delivered to your doorstep! We serve the rural communities near <b>Charusat University</b>, offering a variety of delicious dishes made with locally sourced ingredients.</p>
        ...
        <div class="box-container">
            ...
            <div class="box" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    <p><b>KingsMan Eatery</b></p>
                    <p>Fresh Burgers near <b>Charusat University</b></p>
            ...
            <div class="box" data-aos="fade-up">
                <div class="image">
                    ...
                    <h3> <i class="fas fa-utensils"></i> Matka Dosa</h3>
                </div>
                <div class="content">
                    <div class="price"> 250.99 <span>300.99</span> </div>
                    <p><b>Shiv Chulha Dosa</b></p>
                    <p>Delicious Fensi Dosa's near <b>Charusat Chokdi</b></p>
                    <!-- <a href="#" class="btn"> Order now</a> -->
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    <p><b>Nidhisa Canteen</b></p>
                    <p>Delicious Dabeli and more FastFood item at <b>Charusat University</b></p>
                    <!-- <a href="#" class="btn"> Order now</a> -->
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up">
                ...
                <div class="content">
                    ...
                    <p><b>Patel Reasuarent</b></p>
                    <p>Testy pulav near <b>Valetva Chokdi</b></p>
                    <!-- <a href="#" class="btn"> Order now</a> -->
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up">
                ...
                <div class="content">
                    <div class="price">70.00 <span>100.00</span> </div>
                    <p><b>Pinky Mug Pulav & Vada Pav</b></p>
                    <p>Mouth Watering Mug Pulav near <b>Charusat University</b></p>
                    <!-- <a href="#" class="btn"> Order now</a> -->
                </div>
            </div>
